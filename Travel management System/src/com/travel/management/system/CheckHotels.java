...
public class CheckHotels extends JFrame implements Runnable {
	...
	@Override
	public void run() {
		String[] text = new String[] {"JW Marriott Hotel","Madrin Oriental Hotel","Four Seasons Hotel","Raddissson Blue Hotel","Classic Hotel","The bay Club Hotel","Breez Hotel","The Taj Hotel","Happy Morning Motel","River view Hotel"};
